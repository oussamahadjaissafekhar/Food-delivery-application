...
const {Authentication ,addUser ,Restaurants,RestaurantMenu,addOrder,addRating} = require('./AppRestaurentBack');
...
const server = http.createServer(async (req, res) => {
  if (req.method === 'POST') {
    ...
    req.on('end', async () => {
      ...
      const formData = querystring.parse(body); 
      console.log("formData : ",formData); 
      const Rating = JSON.parse(formData.rating);
      console.log("Rating : ",Rating.restaurant_id);
      try{
